...
verilator -WAll --cc ../../rtl_pipelined/fetch.sv
...
verilator -Wall --cc ../../rtl_pipelined/decode.sv
...
verilator -Wall --cc ../../rtl_pipelined/execute.sv
...
verilator -Wall --cc ../../rtl_pipelined/memory.sv

# writeback pipeline
verilator -Wall --cc ../../rtl_pipelined/writeback_pipeline.sv

# writeback
verilator -Wall --cc ../../rtl_pipelined/writeback.sv

# hazard detection
verilator -Wall --cc ../../rtl_pipelined/hazard_unit.sv

# master
verilator -Wall --cc --trace ../../rtl_pipelined/pipelined_cpu.sv --exe pipe_cpu_tb.cpp
